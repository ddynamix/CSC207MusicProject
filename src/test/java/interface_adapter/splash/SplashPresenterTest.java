...
class SplashPresenterTest {
    ...
    void setUp() {
        ...
        signupSelectorViewModel = mock(SignupSelectorViewModel.class);

        splashPresenter = new SplashPresenter(viewManagerModel, loginViewModel, signupSelectorViewModel);
    }

    @Test
    void testPrepareSignupView() {
        String expectedSignupViewName = "signupView";
        when(signupSelectorViewModel.getViewName()).thenReturn(expectedSignupViewName);
